    ...
    <main className="py-16 lg:py-24">
      <div className="container grid lg:grid-cols-2 gap-10 items-start">
        <div>
          ...
          <p className="mt-3 text-neutral-600">Questions about our barista training, beans, or plantation tours? Send us a note.</p>
          <form className="mt-6 grid gap-4">
            ...
            <button type="button" className={`btn ${theme.brandBg} ${theme.brandBgHover} text-white`}>Send Message</button>
          </form>
        </div>
